...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 NMDA /cygdrive/c/Documents and Settings/bpg/Desktop/Projects/CortDyn/Subprojects/CA1rhythms/Code/Neuron/ThetaGamma/nmda.mod\n");
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 if ( _args[4]  == 0.0 ) {
   ...
   state_discontinuity ( _cvode_ieq + 0, & a , a + _lx ) ;
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 47 in file nmda.mod:\n	SOLVE states METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
