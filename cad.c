	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 cad /cygdrive/c/Documents and Settings/bpg/Desktop/Projects/CortDyn/Subprojects/CA1rhythms/Code/Neuron/ThetaGamma/cad.mod\n");
...
/*CVODE*/
 static int _ode_spec1 () {_reset=0;
 {
   ...
   Dca = drive_channel / ( 1.0 + bcap ) + ( cainf - ca ) / taur ;
   cai = ca ;
   }
 return _reset;
}
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 82 in file cad.mod:\n	SOLVE state METHOD euler\n"); nrn_complain(_p); abort_run(error);}
