...
extern int nrn_get_mechtype();
 ...
 "setdata_carF", _hoc_setdata,
 "mhn_carF", _hoc_mhn,
 "vartau_carF", _hoc_vartau,
 "varss_carF", _hoc_varss,
 0, 0
};
#define vartau vartau_carF
#define varss varss_carF
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 carF /cygdrive/c/Documents and Settings/bpg/Desktop/Projects/CortDyn/Subprojects/CA1rhythms/Code/Neuron/ThetaGamma/carF.mod\n");
...
double varss ( _p, _ppvar, _thread, _nt, _lv , _li ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _li ;
 {
   double _lvarss;
 if ( _li  == 0.0 ) {
     _lvarss = 1.0 / ( 1.0 + exp ( ( _lv - vha ) / ( ka ) ) ) ;
     }
   else if ( _li  == 1.0 ) {
     _lvarss = 1.0 / ( 1.0 + exp ( ( _lv - vhi ) / ( ki ) ) ) ;
     }
...
double vartau ( _p, _ppvar, _thread, _nt, _lv , _li ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _li ;
 {
   double _lvartau;
 if ( _li  == 0.0 ) {
...
static int  mhn ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   double _la , _lb ;
