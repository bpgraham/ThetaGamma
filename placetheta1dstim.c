...
#define _tqitem &(_ppvar[3]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 PT1dStim /cygdrive/c/Documents and Settings/bpg/Desktop/Projects/CortDyn/Subprojects/CA1rhythms/Code/Neuron/ThetaGamma/placetheta1dstim.mod\n");
...
double rate (  )  {
   double _lrate;
 _lrate = 0.0 ;
   if ( t >= start  && x < maxdist ) {
     x = ( t - start ) * speed / 1000.0 ;
     placefr = maxfr * exp ( - pow( ( x - plx0 ) , 2.0 ) / ( 2.0 * pow( plsig , 2.0 ) ) ) ;
