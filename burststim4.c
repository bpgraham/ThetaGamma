...
#define erand erand_BurstStim4
#define invl invl_BurstStim4
 extern double erand( );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 BurstStim4 /cygdrive/c/Documents and Settings/bpg/Desktop/Projects/CortDyn/Subprojects/CA1rhythms/Code/Neuron/ThetaGamma/burststim4.mod\n");
...
{
 {
   ...
   if ( start >= 0.0  && number > 0.0 ) {
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, t +  start , 3.0 ) ;
     }
   }
